...
fun MotionLabScreen(factory: AppViewModelFactory) {
    ...
    Column(
        ...
        Text(stringResource(R.string.lab_movimiento_titulo), style = MaterialTheme.typography.headlineMedium, fontWeight = FontWeight.Bold)
        Text(stringResource(R.string.lab_movimiento_instruccion), style = MaterialTheme.typography.bodyLarge, modifier = Modifier.padding(top = 4.dp, bottom = 16.dp))
